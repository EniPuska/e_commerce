...
<?php 
  if(isset($_GET['id'])){
    ...
    while($row = fetchArray($query)){
      ...
      $short_desc = escape_string($row['product_desc']);
...
<div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <textarea name="short_desc" id="" cols="5" rows="3" class="form-control"><?php echo $short_desc; ?></textarea>
  </div>
   ...
   <!-- Product Categories-->
    <div class="form-group">
        ...
        <select name="product_category_id" id="" class="form-control">
          <option value="<?php echo $product_category_id; ?>"><?php echo showProductCatTitle($product_category_id); ?></option>
